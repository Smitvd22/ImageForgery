...
def switch_dataset(target_dataset):
    ...
    # Available datasets
    valid_datasets = ["4cam", "misd", "imslice"]
    ...
    for i, line in enumerate(lines):
        if line.strip().startswith('ACTIVE_DATASET = '):
            lines[i] = f'ACTIVE_DATASET = "{target_dataset}"  # Options: "4cam", "misd", "imslice"'
            break
...
def main():
    ...
    parser.add_argument("--switch", choices=["4cam", "misd", "imslice"], 
